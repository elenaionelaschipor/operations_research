...
def Plot_graph(G,stop = False, values = None, scattercolor = "grey", fig = None, ax = None):
    ...
    if values == None:
        values = [0 for _ in range(len(G.nodes()))]  
...
if __name__ == "__main__":
    cane = plt.imread('C:/Users/elena/Documents/GitHub/operations_research/project_2025/images/cane_piccolissimo.jpg')
    plt.imshow(cane)
    plt.axis('off')
    plt.show()
    ...
    sets = []
    for i in range(11):
        sub_nodes = list(G.nodes)[i*190: 190*(i+1)]  # primi 100 nodi
